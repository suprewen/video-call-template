    ...
    <main>
      ...
      <section className="workspace">
        <div className="preview-wrap">
          <Player component={VideoCallTemplate} inputProps={inputProps} durationInFrames={durationInFrames} compositionWidth={720} compositionHeight={1280} fps={30} controls={false} autoPlay loop style={{width: '100%', aspectRatio: '9 / 16'}} />
        </div>
